                    ...
                    <form action='edit.php' method='POST'>
                        <div class='modal-body text-start'>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="number" name="edit_id_producto" id="edit_id_producto" class="form-control" placeholder="123" required>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="edit_id_provedoor" class="form-label">Id Provedoor</label>
                                <input type="number" name="edit_id_provedoor" id="edit_id_provedoor" class="form-control" placeholder="123" required>
                            </div>

                            <div class="col-12 mb-3">
                                <label for="edit_id_precio_paquete" class="form-label">Precio Paquete</label>
                                <input type="text" name="edit_id_precio_paquete" id="edit_id_precio_paquete" class=" form-control" placeholder="123" required>
                            </div>


                            <div class="col-12 mb-3">
                                <label for="edit_id_descripcion" class="form-label">Descripcion</label>
                                <input type="text" name="edit_id_descripcion" id="edit_id_descripcion" class=" form-control" placeholder="a base de aloe vera etc" required>
                            </div>

                            <div class="col-12 mb-3">
                                <label for="edit_id_precio_unidad" class="form-label">Precio Unidad</label>
                                <input type="text" name="edit_id_precio_unidad" class="form-control" id="edit_id_precio_unidad" placeholder="$" required>
                            </div>

                            <div class="col-12 mb-3">
                                <label for="edit_categoria" class="form-label">Categoria</label>
                                <input type="text" name="edit_categoria" id="edit_categoria" class=" form-control" placeholder="skincare" required>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="edit_nombre" id="edit_nombre" class=" form-control" placeholder="base" required>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('.editButton').on('click', function() {
                ...
                $('#edit_id_provedoor').val(data[3]);
                $('#edit_id_precio_paquete').val(data[4]);
                $('#edit_id_descripcion').val(data[5]);
                $('#edit_id_precio_unidad').val(data[6]);
                $('#edit_categoria').val(data[7]);
                $('#edit_num').val(data[8]);
                $('#edit_nombre').val(data[9]);
